...
import { ProcessExportComponent } from "./components/processcomponent";
import { TeamExportComponent } from "./components/teamcomponent";
...
export class MainComponent extends React.Component<IMainComponentProps, IMainComponentState> {
    ...
    public render(): JSX.Element {
        if (!this.state || this.state.loadState === LoadingState.None) {
            return (
                <div>
                    <div className="widget"><ProcessExportComponent /></div>
                    <div className="widget"><TeamExportComponent /></div>
                </div>
            );
        ...
        if (this.state.loadState === LoadingState.Loaded) {
            ...
            return <div>Loading...</div> //<SpinnerComponent />
        }        
